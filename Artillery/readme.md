...
#### Домашнее задание
1. Создать таблицу с настройками для проверки входных данных. В рамках данной таблицы нужно хранить `константы`
...
- `Направление ветра`. Минимальное значение 0,максимальное значение 59
  и т.д.
